    ...
    <header className="sticky top-0 z-10 border-b border-slate-200/20 bg-white/80 backdrop-blur dark:bg-slate-800/50 dark:border-slate-700/30">
      <div className="container flex h-16 items-center justify-between py-4">
        <div className="flex flex-1 items-center">
          <h1 className="ml-2 text-sm font-bold md:text-base bg-gradient-to-r from-health to-sport bg-clip-text text-transparent">
            {pageTitle}
          </h1>
        </div>
        <div className="flex items-center gap-4">
          ...
          <div className="hidden md:flex items-center gap-2">
            <Button variant="ghost" size="icon" className="relative text-muted-foreground hover:text-foreground">
              ...
              <span className="absolute -top-1 -right-1 h-4 w-4 rounded-full bg-health flex items-center justify-center text-[10px] text-white font-medium">+8%</span>
            </Button>
            <Button variant="ghost" size="icon" className="relative text-muted-foreground hover:text-foreground">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" className="relative h-9 w-9 rounded-full overflow-hidden bg-health/10 hover:bg-health/20 transition-colors">
                <Avatar className="h-9 w-9 border-none">
                  ...
                  <AvatarFallback className="bg-transparent text-health-dark dark:text-health-light">НП</AvatarFallback>
                </Avatar>
              </Button>
            </DropdownMenuTrigger>
