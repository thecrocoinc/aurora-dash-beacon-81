...
/**
 * Utility for generating fake profile data for demonstration purposes
 */
...
/**
 * Generate a list of fake profiles for demo purposes
 * @param count Number of fake profiles to generate
 * @returns Array of fake profile data
 */
export const generateFakeProfiles = (count: number = 15): FakeProfileData[] => {
